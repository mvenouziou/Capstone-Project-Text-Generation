# -*- coding: utf-8 -*-
"""Partial Copy of Mo_nonlinear_text_gen.ipynb
...
#### PACKAGE IMPORTS ####
# Custom functions
import text_gen_architecture as architecture
import text_gen_paramaters as paramaters
...
# NOTE: REQUIRED FOR SAVE / LOAD / CHECKPOINT operations
...
use_gdrive=False  # NOTE: 'True' required for save / load / checkpoint operations
use_anvil=False
...
PARAMATERS = paramaters.Paramaters(use_gdrive=use_gdrive, use_anvil=use_anvil, 
...
model = architecture.GenerationModel(paramaters=PARAMATERS)
